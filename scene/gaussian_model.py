...
class GaussianModel:
    ...
    @get_vmask.setter
    def get_vmask(self, new_value):
        self.vmask = new_value
    ...
    def training_setup(self, training_args):
        ...
        self.vmask = torch.zeros((self.get_xyz.shape[0]), device="cuda")     # (P, 1)
        ...
        l = [
            ...
            {'params': self._nlgs.view0_params(), 'lr': 0.0001, "name": "view"},
            {'params': self._nlgs.view1_params(), 'lr': 0.0001, "name": "view"},
    ...
    def prune_points(self, mask):
        ...
        self.vmask = self.vmask[valid_points_mask]
    ...
    def densification_postfix(self, new_xyz, new_opacities, new_scaling, new_rotation, new_vmask):
        d = {"xyz": new_xyz,
        ...
        self.vmask = torch.cat((self.vmask, new_vmask), dim=0)
        self.max_radii2D = torch.zeros((self.get_xyz.shape[0]), device="cuda")
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        new_vmask = self.vmask[selected_pts_mask].repeat(N) 

        self.densification_postfix(new_xyz, new_opacity, new_scaling, new_rotation, new_vmask)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        new_vmask = self.vmask[selected_pts_mask]

        self.densification_postfix(new_xyz, new_opacities, new_scaling, new_rotation, new_vmask)
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, iteration):
        if self.densify_ema:
            ...
            # print(torch.sum(self.denom < 30) / num)
            # print(torch.sum(self.denom > 50) / num)
        else:
